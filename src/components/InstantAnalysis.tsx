      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 flow-root">
          <div className="relative rounded-xl bg-gray-900/5 p-8">
            <div className="absolute inset-0 bg-gradient-to-r from-[#007bff]/10 to-[#0056b3]/10 rounded-xl" />
            
            <div className="relative">
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
                  <Upload className="h-10 w-10 text-[#007bff] mb-4" />
                ...
                <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
                  <Search className="h-10 w-10 text-[#007bff] mb-4" />
                ...
                <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-sm">
                  <Sparkles className="h-10 w-10 text-[#007bff] mb-4" />
              ...
              <div className="mt-12 flex justify-center">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-md bg-[#007bff] px-8 py-4 text-lg font-semibold text-white shadow-sm hover:bg-[#0056b3] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#007bff] transition-all duration-200"
                >
                  Try Free Analysis
          ...
          <div className="mt-16 rounded-2xl bg-gray-50 p-8">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg">
                <img
                  src="https://ik.imagekit.io/appraisily/WebPage/appraisily.com_an_image_for_an_online_art_appraisal_service_tha_aa009cf3-7aa8-493f-a3e5-6dee036f5311.png?tr=w-800,h-600,q-80"
